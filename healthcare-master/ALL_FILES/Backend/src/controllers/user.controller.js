...
// import { uploadOnCloudinary } from "../utils/Cloudinary.js"; // Disabled to prevent Cloudinary errors
...
const registerUser = asyncHandler(async (req, res) => {
    ...
    const avatarUrl = req.file ? req.file.path : "https://via.placeholder.com/150?text=User";
    ...
    // Avatar handled above - using placeholder or uploaded URL
