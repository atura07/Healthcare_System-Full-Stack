...
const registerDoctor = asyncHandler(async (req, res) => {
    ...
    // Avatar optional for local demo
    ...
    // Skip Cloudinary for local demo, use placeholder
    const avatarUrl = "https://via.placeholder.com/150x150/4CAF50/FFFFFF?text=Doctor";
